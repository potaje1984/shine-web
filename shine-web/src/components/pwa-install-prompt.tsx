...
export function PwaInstallPrompt() {
  ...
  return (
    <>
      {/* Backdrop — separate from card, closes on tap */}
      <div
      ...
      {/* Card — above backdrop */}
      <div className="fixed inset-0 z-[91] pointer-events-none flex items-end justify-center sm:items-center">
        <div
          className="pointer-events-auto relative mx-4 mb-6 w-full max-w-sm animate-in slide-in-from-bottom-4 rounded-2xl border border-white/10 bg-card p-5 shadow-2xl sm:mb-0"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Close button */}
          <button
            onClick={(e) => handleDismiss(e)}
            className="absolute -right-2 -top-2 flex h-9 w-9 items-center justify-center rounded-full bg-white/15 text-white shadow-lg transition-colors hover:bg-white/25 active:scale-95"
